...
class ZonaEducativaController
{
	...
	function __construct()
	{
 	...
 	function ListarZonaEducativa(){
		 require_once(dirname(__FILE__).'/../views/zona_educativa/list_zona_educativa.php');
	}

	static public function ListarZonaEducativa1(){
	   	 require_once(dirname(__FILE__).'/../models/ZonaEducativaModel.php');
  ...
  // Para insertar
	...
	function IngresarZonaEducativa(){
		 require_once(dirname(__FILE__).'/../views/zona_educativa/insert_zona_educativa.php');
	}

	function IngresarZonaEducativa1(){
		 require_once(dirname(__FILE__).'/../views/zona_educativa/insert_zona_educativa1.php');
	}
	...
	function UpdateZonaEducativa(){
		 require_once(dirname(__FILE__).'/../views/zona_educativa/update_zona_educativa.php');
	}

	function UpdateZonaEducativa1(){
		 require_once(dirname(__FILE__).'/../views/zona_educativa/update_zona_educativa1.php');
	}
  ...
  // Para eliminar
	...
	function DeleteZonaEducativa(){
		 require_once(dirname(__FILE__).'/../views/zona_educativa/deleted_zona_educativa.php');
	}
