...
class AcumulanController
{
	...
	function __construct()
	{
 	...
 	function ListarAcumulan(){
		 require_once(dirname(__FILE__).'/../views/acumulan/list_acumulan.php');
	}

	static public function ListarAcumulan1(){
	   	 require_once(dirname(__FILE__).'/../models/AcumulanModel.php');
  ...
  // Para insertar
	...
	function IngresarAcumulan(){
		 require_once(dirname(__FILE__).'/../views/acumulan/insert_acumulan.php');
	}

	function IngresarAcumulan1(){
		 require_once(dirname(__FILE__).'/../views/acumulan/insert_acumulan1.php');
	}
	...
	function UpdateAcumulan(){
		 require_once(dirname(__FILE__).'/../views/acumulan/update_acumulan.php');
	}

	function UpdateAcumulan1(){
		 require_once(dirname(__FILE__).'/../views/acumulan/update_acumulan1.php');
	}
  ...
  // Para eliminar
	...
	function DeleteAcumulan(){
		 require_once(dirname(__FILE__).'/../views/acumulan/deleted_acumulan.php');
	}
