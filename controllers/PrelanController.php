...
class PrelanController
{
	...
	function __construct()
	{
 	...
 	function ListarPrelan(){
		 require_once('views/prelan/list_prelan.php');
	}

	static public function ListarPrelan1(){
	   	 require_once('models/PrelanModel.php');
  ...
  // Para insertar
	...
	function IngresarPrelan(){
		 require_once('views/prelan/insert_prelan.php');
	}

	function IngresarPrelan1(){
		 require_once('views/prelan/insert_prelan1.php');
	}
	...
	/*function UpdatePrelan(){
		 require_once('views/prelan/update_prelan.php');
	}

	function UpdatePrelan1(){
		 require_once('views/prelan/update_prelan1.php');
	}
  ...
  // Para eliminar
	...
	function DeletePrelan(){
		 require_once('views/prelan/deleted_prelan.php');
	}
