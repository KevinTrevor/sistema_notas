...
class MatriculanController
{
	...
	function __construct()
	{
 	...
 	function ListarMatriculan(){
		 require_once('views/matriculan/list_matriculan.php');
	}

	static public function ListarMatriculan1(){
	   	 require_once('models/MatriculanModel.php');
  ...
  // Para insertar
	...
	function IngresarMatriculan(){
		 require_once('views/matriculan/insert_matriculan.php');
	}

	function IngresarMatriculan1(){
		 require_once('views/matriculan/insert_matriculan1.php');
	}
	...
	function UpdateMatriculan(){
		 require_once('views/matriculan/update_matriculan.php');
	}

	function UpdateMatriculan1(){
		 require_once('views/matriculan/update_matriculan1.php');
	}
  ...
  // Para eliminar
	...
	function DeleteMatriculan(){
		 require_once('views/matriculan/deleted_matriculan.php');
	}
