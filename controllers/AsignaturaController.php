...
class AsignaturaController
{
	...
	function __construct()
	{
 	...
 	function ListarAsignatura(){
		 require_once(dirname(__FILE__).'/../views/asignatura/list_asignatura.php');
	}

	static public function ListarAsignatura1(){
	   	 require_once(dirname(__FILE__).'/../models/AsignaturaModel.php');
  ...
  // Para insertar
	...
	function IngresarAsignatura(){
		 require_once(dirname(__FILE__).'/../views/asignatura/insert_asignatura.php');
	}

	function IngresarAsignatura1(){
		 require_once(dirname(__FILE__).'/../views/asignatura/insert_asignatura1.php');
	}
	...
	function UpdateAsignatura(){
		 require_once(dirname(__FILE__).'/../views/asignatura/update_asignatura.php');
	}

	function UpdateAsignatura1(){
		 require_once(dirname(__FILE__).'/../views/asignatura/update_asignatura1.php');
	}
  ...
  // Para eliminar
	...
	function DeleteAsignatura(){
		 require_once(dirname(__FILE__).'/../views/asignatura/deleted_asignatura.php');
	}
