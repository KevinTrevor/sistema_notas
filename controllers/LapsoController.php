...
class LapsoController
{
	...
	function __construct()
	{
 	...
 	function ListarLapso(){
		 require_once(dirname(__FILE__).'/../views/lapso/list_lapso.php');
	}

	static public function ListarLapso1(){
	   	 require_once(dirname(__FILE__).'/../models/LapsoModel.php');
  ...
  // Para insertar
	...
	function IngresarLapso(){
		 require_once(dirname(__FILE__).'/../views/lapso/insert_lapso.php');
	}

	function IngresarLapso1(){
		 require_once(dirname(__FILE__).'/../views/lapso/insert_lapso1.php');
	}
	...
	function UpdateAnoEscolar(){
		 require_once(dirname(__FILE__).'/../views/lapso/update_lapso.php');
	}

	function UpdateAnoEscolar1(){
		 require_once(dirname(__FILE__).'/../views/lapso/update_lapso1.php');
	}
  ...
  // Para eliminar
	...
	function DeleteLapso(){
		 require_once(dirname(__FILE__).'/../views/lapso/deleted_lapso.php');
	}
