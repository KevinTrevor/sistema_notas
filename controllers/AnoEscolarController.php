...
class AnoEscolarController
{
	...
	function __construct()
	{
 	...
 	function ListarAnoEscolar(){
		 require_once('views/ano_escolar/list_ano_escolar.php');
	}

	static public function ListarAnoEscolar1(){
	   	 require_once('models/AnoEscolarModel.php');
  ...
  // Para insertar
	...
	function IngresarAnoEscolar(){
		 require_once('views/ano_escolar/insert_ano_escolar.php');
	}

	function IngresarAnoEscolar1(){
		 require_once('views/ano_escolar/insert_ano_escolar1.php');
	}
	...
	function UpdateAnoEscolar(){
		 require_once('views/ano_escolar/update_ano_escolar.php');
	}

	function UpdateAnoEscolar1(){
		 require_once('views/ano_escolar/update_ano_escolar1.php');
	}
  ...
  // Para eliminar
	...
	function DeleteAnoEscolar(){
		 require_once('views/ano_escolar/deleted_ano_escolar.php');
	}
